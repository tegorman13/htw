...
```{r}
# load and view data
pacman::p_load(tidyverse,data.table,lme4,future,furrr,abc,mvtnorm,patchwork)
...
ggsave("images/abc_constant.png",postC/(gcp + gco),width=12,height=10)

```

![](images/abc_constant.png)
