...
fixed_effect_interaction <- fixef(e3_vxBMM)[,1]["conditVaried:bandInt"]
...
pid_slopes3 <- re |>  mutate(id=reorder(id,slope)) |>
  ggplot(aes(y=id, x=slope,fill=condit,color=condit)) + 
    ...
    ggh4x::facet_wrap2(bandOrder~condit,axes="all",scales="free_y")
