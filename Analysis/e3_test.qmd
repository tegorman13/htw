...
In experiment 3, the effect of training condition shows the opposite pattern of the previous two experiments. The moderately strong effect of condition is for the varied group to show less deviation (β = -91.09, 95% CI [-182.79, 3.75]), with 97% of the posterior distribution falling under 0. 
