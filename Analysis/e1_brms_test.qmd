...
e1_testDistRF2_0 |> spread_draws(b_conditConstant,b_conditVaried,b_vb[vb,])


e1_testDistRF2_0 |> spread_draws(r_id[id,term]) |> head(10)


e1_testDistRF2_0 |> spread_draws(b_conditConstant,b_conditVaried) |> compare_levels(condit)
