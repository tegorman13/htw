...
In summary, variable training led to lower performance accuracy, impaired extrapolation to new stimuli, and decreased discrimination sensitivity compared to focused training on a single stimulus category. 
