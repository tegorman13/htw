...
#dtestAgg %>% plotDist()
dtestAgg %>% filter(bandOrder=="Original") %>% plotDist(title="Empirical Vx - Original Order",fcap=fig1aCap)
dtestAgg %>% filter(bandOrder=="Reverse") %>% plotDist(title="Empirical Vx - Reverse Order",fcap=fig1bCap)
