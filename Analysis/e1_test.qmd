...
#| fig-height: 11
nSbj <- 3
indvDraws  |> indv_model_plot(indv_coefs, testAvg, rank_variable=Estimate.bandInt,n_sbj=nSbj,"max")
indvDraws |> indv_model_plot(indv_coefs, testAvg, rank_variable=Estimate.bandInt,n_sbj=nSbj,"min")
