...
#| fig-width: 12
nSbj <- 3
indvDraws  |> indv_model_plot(indvSlopes, testAvg, Slope,rank_variable=Slope,n_sbj=nSbj,"max")
indvDraws |> indv_model_plot(indvSlopes, testAvg,Slope, rank_variable=Slope,n_sbj=nSbj,"min")
