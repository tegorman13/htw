...
#| fig-subcap: ["Slope estimates by participant - ordered from lowest to highest within each condition. ", "Model fit to only 3 extrapolation bands"]
#| fig-height: 9
#| fig-width: 10
