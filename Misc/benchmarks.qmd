...
options(mc.cores = 4, brms.backend = "cmdstanr",brms.silent=0)
...
tf2 <- system.time(
fit_int_norm <- brm(vx ~ 1 +(1|bandInt) + (1|id),
...
cat(paste0("brms int only gaussian=",round(tf["elapsed"],2)," \n ",
