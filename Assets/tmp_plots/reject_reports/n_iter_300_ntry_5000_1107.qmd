...
```{r}
pacman::p_load(dplyr,purrr,tidyr,ggplot2, data.table, here, patchwork, conflicted, stringr,future,furrr, knitr, reactable, flextable, ggstance)
...
source("../../../Functions/fun_model.R")
source("../../../Functions/fun_alm.R")
...
pd_train_l |> ggplot(aes(x=Block,y=val,col=Resp))+
  ...
  coord_cartesian(ylim = c(600, 1300)) +labs(title="Full Posterior")
