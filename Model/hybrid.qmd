...
"e1_hybrid_n_iter_150_ntry_150_4749")
...
ind_fits_df |> ggplot(aes(x=condit,y=weight_exam,col=condit)) + stat_pointinterval() +
  facet_wrap(~Fit_Method)

ind_fits_df |> 
   filter(id %in% unique(ind_fits_df$id)[1:50], Fit_Method=="Test") |>
...
all_fits |> 
   filter(id %in% unique(ind_fits_df$id)[1:50], Fit_Method=="Test_Train") |>
    ggplot(aes(x=weight_exam,fill=condit)) +
  geom_density() +
  geom_vline(xintercept = .5,linetype="dashed") +
  ggh4x::facet_wrap2(~id+condit, scales="free_y")
...
folder_names <- c("e2_hybrid_n_iter_60_ntry_150_3658","e2_hybrid_n_iter_250_ntry_200_0540","e2_hybrid_n_iter_150_ntry_150_2904")
...
folder_names <- c("e3_hybrid_n_iter_150_ntry_150_1757","e3_hybrid_n_iter_250_ntry_200_4300","e3_hybrid_n_iter_60_ntry_150_0946")
