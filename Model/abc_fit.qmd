...
run_abc_fits <- function(data, input_layer, output_layer, simulation_function, n_prior_samples = 1000, tol = 0.01, return_dat = "train_data,test_data") {
  ...
  # Return results
  list(abc_train_test = abc_train_test, abc_test = abc_test)
}
...
saveRDS(model_cache,here::here(paste0("data/model_cache/abc_group_",format(Sys.time(), "%H_%M_%OS"),".rds")))
