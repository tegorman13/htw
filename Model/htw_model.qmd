...
#| fig-height: 11
#| fig-width: 11
#| fig-cap: "Posterior predictives for absolute deviation from target (accuracy). Observed data is shown on top, and predictions from each combination of model and fitting method are shown below. "
